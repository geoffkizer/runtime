...
namespace System.Net.Http.Headers
{
    ...
    internal sealed class UriHeaderParser : SingleValueHeaderParser<Uri>
    {
        ...
        public override bool TryParseValue([NotNullWhen(true)] string? value, object? storeValue, ref int index, [NotNullWhen(true)] out Uri? parsedValue)
        {
            parsedValue = null;
